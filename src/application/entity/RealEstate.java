...
public class RealEstate {
  ...
  public RealEstate(int id, String objectNumber, ObjectTypes objectType, String objectDescription, Address address, double squareMeters, double squareMeterPriceCold, double additionalCosts, String notes) {
    this(objectNumber, objectType, objectDescription, address, squareMeters, squareMeterPriceCold, additionalCosts, notes);
    this.id = id;
  }

  @Override
  public String toString() {
    return objectNumber + ": " + objectType + "; Beschreibung: " + objectDescription + ", Größe(qm): " + squareMeters + ", Kaltmiete/qm: " + squareMeterPriceCold + ", Nebenkosten: " + additionalCosts + ", Adresse: " + address.toString() + "\nNotizen: " + notes;
  }
